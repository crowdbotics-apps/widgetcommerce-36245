...
## Project Structure
    ...
    ├── widgetcommerce_36245  # Django project configurations
...
1. Clone this repo and `cd widgetcommerce_36245`
...
2. Clone this repo and `cd widgetcommerce_36245`
